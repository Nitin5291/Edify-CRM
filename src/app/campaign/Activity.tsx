  ...
  return (
    <div>
      ...
      {activityStatus === "activity" ? (
        <ActivityAccordion name="campaignId" id={singleCampaignData?.campaigns?.[0]?.id}/>
      ) : activityStatus === "new_task" ? (
        <NewTask name="campaignId" id={singleCampaignData?.campaigns?.[0]?.id} />
      ) : activityStatus === "new_meeting" ? (
        <NewMeeting name="campaignId" id={singleCampaignData?.campaigns?.[0]?.id} />
      ) : activityStatus === "email" ? (
        <EmailPage name="campaignId" id={singleCampaignData?.campaigns?.[0]?.id} />
      ) : activityStatus === "log_call" ? (
        <LogCall />
      ) : activityStatus === "whatsApp" ? (
        <WhatsApp name="campaignId" id={singleCampaignData?.campaigns?.[0]?.id} />
      ) : activityStatus === "message" ? (
        <Message name="campaignId" id={singleCampaignData?.campaigns?.[0]?.id} />
