  ...
  return (
    <div>
      ...
      {activityStatus === "activity" ? (
        ...
        <NewMeeting name="mainTaskId" id={singleMainTaskData?.id} />
      ) : activityStatus === "email" ? (
        <EmailPage name="mainTaskId" id={singleMainTaskData?.id} />
      ) : activityStatus === "log_call" ? (
        <LogCall />
      ) : activityStatus === "whatsApp" ? (
        <WhatsApp name="mainTaskId" id={singleMainTaskData?.id} />
      ) : activityStatus === "message" ? (
        <Message name="mainTaskId" id={singleMainTaskData?.id} />
