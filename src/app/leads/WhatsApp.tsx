...
export const initialColumnDefsWpMsg: ColDef[] = [
  {
    field: "phoneNumber",
    headerName: "Phone",
    minWidth: 215,
...
const WhatsApp = () => {
  ...
  useEffect(() => {
    dispatch(getMessage({ type: "whatsapp", id: SingleLead?.id }));
    setWhatsAppData({ ...whatsAppData, [`phoneNumber`]: SingleLead?.phone });
  }, []);
  ...
  const handelOnCancel = () => {
    setWhatsAppData({ ...WhatsAppView, [`phoneNumber`]: SingleLead?.phone });
    ...
    <div className="px-5 py-11">
      ...
      <div className="grid gap-2">
        ...
        <Table
          ...
          isLoader={isLoader}
          initialColumnDefs={initialColumnDefsWpMsg}
